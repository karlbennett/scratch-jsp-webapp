package cucumber.scratch.jsp.webapp;
...
@Configuration
@ComponentScan({"cucumber", "scratch.jsp.webapp"})
...
@CucumberOptions(
    ...
    // of their usage.
    glue = {"cucumber.scratch.jsp.webapp"},
    features = "classpath:cucumber/scratch/jsp/webapp",
